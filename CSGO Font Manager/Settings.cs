...
{
    /// <summary>
    /// Persisted user settings only. Runtime/game behavior belongs to Form1 controller partials.
    /// </summary>
    public class Settings
    {
        // Backward-compatibility alias used by older CS2 code. Keep synchronized with Cs2Path.
